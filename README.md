...
Use this example app (<https://github.com/nickjj/docker-rails-example> reference: <https://nickjanetakis.com>.) as a base for new project to Dockerize Rails app due to hard time setting up on Mac environment, there was alot of ruby, gem install permission erros that are a common issue found online
